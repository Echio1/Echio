      ...
      <div className="row d-flex justify-content-center">
        ...
        <div className='container-fluid m-0 p-0'>
          ...
          <div className='row pb-3  ms-0 d-flex justify-content-center'>
            ...
            <div className='col-lg-2 col-sm-4 '>
            <h5>Company</h5>
            <p ><Link className='w-100  team-linkF pe-5' style={{color:"#fff", textDecoration:"none"}} to="/team"> Teams</Link></p>
            <p><Link className='w-100 c-f team-linkF pe-5' style={{color:"#fff", textDecoration:"none"}} href='#contact' to="/">Contact Us</Link></p>
            </div>
              <div className='col-lg-4 col-sm-12 '>
                <h5>Let's do it</h5>
                <div className='row  ms-0 d-flex  align-items-center'>
                <div className='col-lg-2 col-sm-6 '><a href='https://www.linkedin.com/company/echiofy-private-limited/'><FaLinkedinIn size={"20px"} className='footerIcons'/></a></div>
                <div className='col-lg-2 col-sm-6'><a href='https://discord.com/invite/xAWXn4Ftg6'><FaDiscord  size={"20px"} className='footerIcons'/></a></div>
                <div className='col-lg-2 col-sm-6'><a href='https://www.instagram.com/deresports/?hl=en'><RiInstagramFill  size={"20px"} className='footerIcons'/></a></div>
                <div className='col-lg-2 col-sm-6'><a href='https://www.youtube.com/c/deresports/'><FaYoutube  size={"20px"} className='footerIcons'/></a></div>
