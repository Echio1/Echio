...
const Section5 = () => {
    return (
      <>
      <div style={{color:"#fff", background:"#fff", borderTop:"0px solid #E3FEF9"}} className="sec d-flex align-items-center" >
        <div style={{width: "100%",backgroundImage: `url(${pg5img1})`,backgroundSize: "cover",backgroundRepeat: "no-repeat"}}>
            ...
            <div className="row d-flex text-center mt-1">
                <p style={{fontSize:"4rem", fontWeight:"600"}}>What we do in E-Sportss</p>
            </div>
